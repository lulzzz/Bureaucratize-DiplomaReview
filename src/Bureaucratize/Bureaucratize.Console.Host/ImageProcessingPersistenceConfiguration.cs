...
{
    public class ImageProcessingPersistenceConfiguration : IImageProcessingPersistenceConfiguration
    {
        public string DatabaseConnectionString =>
            ConfigurationManager.ConnectionStrings["ImageProcessingDb"].ConnectionString;

        public string FileStorageApiUrl => "http://localhost:50499/api";
            //"http://bureaucratize.localhost/Bureaucratize.FileStorage/api";
